...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    static {
        EmployeeModel  employeeModel1 = new EmployeeModel(UUID.randomUUID().toString(),
                "Ivan", "Petriv", "DAR", "Engineer", "example1@gmail.com", 30000);
        EmployeeModel  employeeModel2 = new EmployeeModel(UUID.randomUUID().toString(),
                "Mary", "Petrov", "DARU", "Women", "example2@gmail.com", 10000);
        EmployeeModel  employeeModel3 = new EmployeeModel(UUID.randomUUID().toString(),
                "Ivan", "Svorov", "DARA", "Postman", "example3@gmail.com", 150000);
